...
import src.hf_sparse_modernbert as hf_sparse_modernbert_module
...
def build_model(
    ...
    elif cfg.name == "hf_sparse_modernbert":
        return hf_sparse_modernbert_module.create_hf_sparse_modernbert_classification(
            num_labels=num_labels,
            pretrained_model_name=cfg.pretrained_model_name,
            use_pretrained=cfg.get("use_pretrained", False),
            model_config=cfg.get("model_config", None),
